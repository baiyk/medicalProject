        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'fileType'        : false,              // Type of files allowed (images, etc)
                    ...
                    input.bind('change', function() {
                        ...
                        if (($data.queue.count + limit) > settings.queueSizeLimit && settings.queueSizeLimit !== 0) {
                            if ($.inArray('onError', settings.overrideEvents) < 0) {
                                alert('一次只能上传 (' + settings.queueSizeLimit + ')个文件.  请重新选择.');
                            }
                    ...
                    if (!file.skip && !file.complete && !file.uploading) {
                        ...
                        if (typeof FormData === 'function' || typeof FormData === 'object') {
                            ...
                            reader.onload = function(e) {
                                ...
                                if (file.name) {
                                    binFile += '; filename="' + escape(file.name) + '"';
                                }
                                binFile += eol;
                                ...
                                for (key in settings.formData) {
                                    binFile += dashes + boundary + eol;
                                    binFile += 'Content-Disposition: form-data; name="' + escape(key) + '"' + eol + eol;
                                    binFile += escape(settings.formData[key]) + eol;
                                }
